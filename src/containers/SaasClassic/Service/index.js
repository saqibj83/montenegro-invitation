                    ...
                    <table className="border-collapse table-auto w-full text-sm bg-black border mt-0  shadow">
                      ...
                      <tbody className="bg-white ">
                        ...
                        <tr className="text-center bg-black">
                          <td colspan="4" className="text-center">
                            <img
                              src="https://cdn.triton-series.com/wp-content/uploads/2019/12/07221218/table-1-day-4.png"
                              alt=""
                              className="inline"
                            />
                            <p className="text-xs italic text-slate-300 leading-3">
                        ...
                        <tr class="hover:bg-gray-100">
                          ...
                          >
                            ...
                            />{" "}
                            <br />
                            <span>TONY G > ELIZABETH CHEN</span>
                            <br />
                            <span>ADRIAN MATEOS > PHIL IVEY, HANDZ</span>
                            <br />
                            <span>PAUL PHUA > FERDINAND PUTRA</span>
                            <br />
                            <span>ST WANG > TONY G</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table className="border-collapse table-auto w-full text-sm bg-black border mt-0  shadow">
                      ...
                      <tbody className="bg-white ">
                        ...
                        <tr className="text-center bg-black">
                          <td colspan="4" className="text-center">
                            <img
                              src="https://cdn.triton-series.com/wp-content/uploads/2019/12/08232946/table-1-day-5.png"
                              alt=""
                              className="inline"
                            />
                            <p className="text-xs italic text-slate-300 leading-3">
                    ...
                    <table className="border-collapse table-auto w-full text-sm bg-black border mt-0  shadow">
                      ...
                      <tbody className="bg-white ">
                        ...
                        <tr className="text-center bg-black">
                          <td colspan="4" className="text-center">
                            <img
                              src="https://cdn.triton-series.com/wp-content/uploads/2019/12/09223103/table-1-day-6.png"
                              alt=""
                              className="inline"
                            />
                            <p className="text-xs italic text-slate-300 leading-3">
                        ...
                        <tr class="hover:bg-gray-100">
                          ...
                          >
                            ...
                            />{" "}
                            <br />
                            <span>PHIL IVEY > PATRIK ANTONIUS</span>
                            <br />
                            <span>DANIEL CATES > ADRIAN MATEOS</span>
                            <br />
                            <span>ST WANG > FERDINAND PUTRA</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
